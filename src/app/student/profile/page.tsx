...
import { LogOut, User, Phone, BookOpen, Calendar, Hash } from 'lucide-react'
      ...
      <div style={{ padding: '16px' }}>
        ...
        <div className="card-elevated" style={{ padding: '20px', marginBottom: '16px' }}>
          ...
          {[
            ...
            { icon: Hash,     label: 'Section',    value: profile?.section },
            { icon: Calendar, label: 'Year',       value: `Year ${profile?.year_of_study}` },
